			...
			*/
			...
			} else // HashTag Doesn't Exist
			{
				...
				sql = "create table " + candidate_table
						+ " (Candidate_id int AUTO_INCREMENT Primary key, Candidate_username varchar(20) NOT NULL, Candidate_password varchar(20), Candidate_name varchar(100), Candidate_email varchar(40), Total_votes int, logintype int not null default 0, blurb varchar(40));";
				ps = c.prepareStatement(sql);
				ps.execute();
