...
public class Vote {
	...
	public static boolean main(String user, String votertable) {
		Connection con = null;
		ResultSet rs = null;
		Statement stmt = null;
		boolean vote_flag = false;
		String uname = user;
		String vtable = votertable;
		...
		//	con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ballotboxdb?user=root&password=root");
			...
			String query = String.format("SELECT Voter_username,voted_flag FROM %s WHERE Voter_username = \"%s\" ;",vtable,uname);
